...
export const EditStock = (props) => {
    ...
    const data = {
        ...
        shares: parseFloat(props.tableMeta.rowData[38].toString().replace(/,/g, '')),
    ...
    return (
        <>
            ...
            <Modal show={showEdit} onHide={handleCloseEdit}>
                ...
                <Modal.Body>
                    <Tabs defaultActiveKey="add-up" id="uncontrolled-tab-example" className="mb-3">
                        <Tab eventKey="add-up" title="Add Up">
                            <p>Entered values will sum up with your previous data!</p>
                            <EditStockFormAdd previousData={data} sendFormData={(e) => receiveFormData(e)} />
                        </Tab>
                        <Tab eventKey="modify" title="Modify">
                            <p>This will override existing data!</p>
                            <EditStockForm previousData={data} sendFormData={(e) => receiveFormData(e)} />
                        </Tab>
                    </Tabs>
                </Modal.Body>
            </Modal>
