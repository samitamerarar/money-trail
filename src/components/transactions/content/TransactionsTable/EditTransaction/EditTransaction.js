                            ...
                            <Col>
                                ...
                                >
                                    <Modal.Header closeButton>
                                        <Modal.Title id="contained-modal-title-vcenter">Edit Transaction</Modal.Title>
                                    </Modal.Header>
                                    <Modal.Body>
                                        <Row className="mb-2">
                                        ...
                                        <EditTransactionForm sendFormData={(e) => this.receiveFormData(e)} previousData={this.props.previousData} />
                                    </Modal.Body>
                                </Modal>
                            </Col>
                        </Row>
