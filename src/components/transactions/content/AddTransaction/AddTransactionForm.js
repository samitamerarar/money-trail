...
const AddTransactionForm = (props) => {
    ...
    const findFormErrors = () => {
        ...
        if (merchant && merchant.length > 50) newErrors.merchant = 'merchant is too long! (50 characters max)';
        ...
        <Container>
            <Form>
                    ...
                    <Col>
                        <Form.Group>
                            ...
                            <Col>
                                ...
                                />
                                <Form.Check inline type="radio" label="Income" name="amount" id="income" onChange={(e) => setField('type', e.target.id)} />
                ...
                <Form.Group>
                    ...
                    <Form.Control type="text" onChange={(e) => setField('merchant', e.target.value)} isInvalid={!!errors.merchant} />
                    <Form.Control.Feedback type="invalid">{errors.merchant}</Form.Control.Feedback>
                </Form.Group>
                ...
                <Form.Group>
                    ...
                    <Form.Control as="select" onChange={(e) => setField('category', e.target.value)} isInvalid={!!errors.category}>
